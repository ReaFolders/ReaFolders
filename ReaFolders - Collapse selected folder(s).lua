-- =====================================================================================================================
-- DESCRIPTION:
--     Collapses all folder tracks that are currently selected in the Track Control Panel.  A folder track is defined as
--     a track that has gone through the conversion process described by the [Convert selected track(s) to folders] script.
-- =====================================================================================================================
...
for iSelectedTrack = 1, #selectedTracks do
    ...
    -- If the selected track is a folder track, put it into a "collapsed" state.

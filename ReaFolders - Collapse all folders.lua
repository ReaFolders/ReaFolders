-- =====================================================================================================================
-- DESCRIPTION:
--     Collapses all folder tracks found in the Track Control Panel.  A folder track is defined as a rack that
...
-- Collapse each track that is a folder track.
for iTrack = 0, (projectTrackCount - 1) do
    ...
    if (IsFolderTrack(currentTrack)) then
        if (IsCollapsedFolderTrack(currentTrack)) then
            DebugMsgL("Folder track " .. currentTrackNumber .. " is already collapsed.")
        else
            DebugMsgL("Folder track " .. currentTrackNumber .. " needs to be collapsed.")
